...
- PANTHEON: Original worlds target 4-9 major gods. For single_ip or multi_ip worlds select 1-5 high-confidence divine entities and never pad the pantheon to satisfy a quota; omission is better than false divinity.
...
const TOP_LEVEL_ORDER: Record<WorldMode, string> = {
  pantheon: "mode, worldName, temporalAnchor, cosmology, fusionAxiom, playerGod, majorGods, minorGods, factions, races, places, majorCharacters, relationsAtAnchor, epochConflict, openingChapterBrief, canonEvents, style, theme",
  creator: "mode, worldName, temporalAnchor, cosmology, fusionAxiom, majorGods, minorGods, factions, races, places, majorCharacters, relationsAtAnchor, epochConflict, openingChapterBrief, canonEvents, style, theme",
};
