...
const TOP_LEVEL_ORDER: Record<WorldMode, string> = {
  pantheon: "mode, worldName, temporalAnchor, cosmology, fusionAxiom, playerGod, majorGods, minorGods, factions, races, places, majorCharacters, epochConflict, canonEvents, style, theme",
  creator: "mode, worldName, temporalAnchor, cosmology, fusionAxiom, majorGods, minorGods, factions, races, places, majorCharacters, epochConflict, canonEvents, style, theme",
};
